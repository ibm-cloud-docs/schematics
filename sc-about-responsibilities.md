...
| Service instance | An entity that consists of resources that are reserved for a particular service. | {{site.data.keyword.bpshort}} service instance such as Workspaces, Actions, Inventories, Blueprints | {{site.data.keyword.bpshort}} service instance such as Agent instance. |
