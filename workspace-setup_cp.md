...
4. Connect your workspace to the `GitHub`, `GitLab`, or `Bitbucket` repository where your Terraform configuration files are stored.
   ...
   {: tip}
    ...
    3. Select the Terraform version that your Terraform configuration files are written in. {{site.data.keyword.bpshort}} supports Terraform version 0.11 and 0.12, 0.13, and 0.14. **Note** Terraform version 0.11 option gets deprecated shortly.
