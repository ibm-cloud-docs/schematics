...
- Select the {{site.data.keyword.cloud_notm}} region you wish to use to manage your {{site.data.keyword.bpshort}} Blueprint environment from. Set the region by running the command `ibmcloud target -r <us-south>`.
