...
1. Download state file from existing workspace using the [POSTMAN](/docs/schematics#get-workspace-template-state) URL to access the Terraform statefile or in local workspace. For more information, refer to [Terraform state file commands](/docs/schematics?topic=schematics-schematics-cli-reference#statefile-cmds).
