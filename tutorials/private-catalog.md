...
4. Go to the **Configure product** tab.
    ...
    9. From the **actions** menu, click **Share** to make your product available to other users in your private catalog. To provide access group and assign your catalog to users, see [Setting up the access groups](/docs/iam?topic=iam-groups&interface=ui).
