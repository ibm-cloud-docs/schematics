...
{{site.data.keyword.bplong_notm}} manages only the resources that are listed in {{site.data.keyword.cloud_notm}} Terraform Provider. For more information, about the list of resources that are supported by {{site.data.keyword.bplong_notm}}, see [IBM Cloud Terraform Provider](https://registry.terraform.io/providers/IBM-Cloud/ibm/latest/docs?){: external} documentation.