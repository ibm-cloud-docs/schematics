...
|7 January 2021 |<ul><li>**Multiple SDK support**: {{site.data.keyword.bplong_notm}} supports `Java`, `Node`, `Python`, and `Go` SDK for the APIs. For more information, see [Schematics API documentation](https://cloud.ibm.com/apidocs/schematics/schematics?code=go)</li></ul>|
