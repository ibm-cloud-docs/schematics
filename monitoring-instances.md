...
7. Click `Save`. 
   ...
   For more information, about deleting a dashboard, refer to [Deleting a dashboard](/docs/monitoring?topic=monitoring-remove).
   {: note}
