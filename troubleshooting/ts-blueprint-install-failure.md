...
Finally, run the `ibmcloud schematics blueprint run apply` command to rerun the failed Terraform Apply operation and to complete all operations against all modules.  
...
Run the `ibmcloud schematics blueprint run apply` command to rerun the failed Terraform Apply operation and complete all operations against all modules.  
...
Run the `ibmcloud schematics blueprint config update` command to refresh the blueprint configuration with the changes. It updates the blueprint and modules with the updated input values. 
...
Finally, run the `ibmcloud schematics blueprint run apply` command to rerun the failed Terraform Apply operation with the changed input values and complete all operations against all modules.  
...
```sh
ibmcloud schematics blueprint config update --id <blueprint_ID> --inputs <name>=<value>
```
{: pre}

Finally, run the `ibmcloud schematics blueprint run apply` command to rerun the failed Terraform Apply operation with the updated dynamic inputs and complete all operations against all modules.  
