...
3. In the **Import your Terraform template** section, enter the following information: 
    ...
    2. Select `terraform_v0.12` from the **Terraform version** drop down. **Note** Select `Terraform_v1.0` to use Terraform version 1.0, and similarly, `terraform_v0.15`, `terraform_v0.14`, `terraform_v0.13`, `terraform_v0.12`. For example, when you specify `terraform_v1.0` then it means users can have template that may be of `v1.0.0`, `v1.0.1`, or `v1.0.2`, so on.
