...
Use the {{site.data.keyword.IBM_notm}} provided Terraform, or Tofu template to provision an {{site.data.keyword.cos_full_notm}} instance with a {{site.data.keyword.bpshort}} workspace. 
{: shortdesc}
