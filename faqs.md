...
Your files must be placed in the `/tmp/.schematics` folder and the size limit is set to `10 MB'. {{site.data.keyword.bpshort}} backups and restores all the files in the `tmp` folder.
