...
| Combine with other configuration management tools | Use {{site.data.keyword.cloud_notm}} Schematics to provision your {{site.data.keyword.cloud_notm}} resources, and install or configure more software by using other configuration tools, such as Ansible, Chef, or Puppet.  
...
<dl>
  <dt>Template</dt>
  <dd>A Schematics template includes one or a set of Terraform configuration files that combined can be used to build a specific {{site.data.keyword.cloud_notm}} resource configuration. For example, you might have a template that creates a multizone cluster in {{site.data.keyword.containerlong_notm}}. This cluster consists of multiple {{site.data.keyword.cloud_notm}} resources in different zones, such as classic infrastructure virtual servers and VLANs. You can build your own template and import it into {{site.data.keyword.cloud_notm}} Schematics by storing all Terraform configuration files that build your configuration in one GitHub or GitLab repository. Templates are designed and constructed for reuse by using variables so that you can share these templates with other teams in your organization.  </dd>
</dl>
