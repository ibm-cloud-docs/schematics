...
|Execution plan|A Terraform execution plan is a summary of actions that {{site.data.keyword.bpshort}} must perform to provision, modify, or remove the {{site.data.keyword.cloud_notm}} resources of your template. |
