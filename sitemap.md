...
## Understanding security and compliance with Schematics
{: #sitemap_understanding_security_and_compliance_with_schematics}
...
[Terraform documentation](https://developer.hashicorp.com/terraform/docs){: external}
