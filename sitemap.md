...
* [How to rectify failed to clone Git repository, might not find remote refs or heads or master most likely invalid branch name is passed?](/docs/schematics?topic=schematics-general-faq#template-errors)
...
* [If I set `type: = terraform_v1.4` in the JSON file as shown in the code block, does Terraform version 1.4 continue to use even if Terraform version 2.0 or higher are released?](/docs/schematics?topic=schematics-general-faq#terraform-type-faq)
