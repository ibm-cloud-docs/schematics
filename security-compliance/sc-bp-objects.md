...
### What are the best practices that I must follow when developing the Terraform templates, and publishing the same in the Git repositories?
...
- Do use only [allowed list file extensions](/docs/schematics?topic=schematics-faqs&interface=api#clone-file-extension) in your repository.
...
### What are the best practices that I must follow when creating a Workspace for the Terraform template?
{: #bp-security-wks}
...
### How does {{site.data.keyword.bpshort}} protect my Workspace data through Terraform state file, or log files, and so on?
{: #bp-protect-data}
...
### What are the best practices that I must follow when creating an Action for the Ansible template?
{: #bp-security-ansible}
...
### How does {{site.data.keyword.bpshort}} protect my Action data through input credentials state file, or log files, and so on?
{: #bp-security-protect}

Follow these practices to protect your Workspace data through input credentials state file, or log files, and so on.
