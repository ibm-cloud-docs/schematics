...
If the `destroyresource` flag is set to `true`, refresh token header configuration is required to delete all the {{site.data.keyword.cloud_notm}} resources, and the Schematics workspace. Following are the uses of refresh token header:
