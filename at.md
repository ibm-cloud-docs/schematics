...
2. [Launch the {{site.data.keyword.cloudaccesstrailshort}} web console](/docs/Activity-Tracker-with-LogDNA?topic=Activity-Tracker-with-LogDNA-launch#launch_step2) to access your events.
