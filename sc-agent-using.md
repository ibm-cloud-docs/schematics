...
![{{site.data.keyword.bpshort}} Agents set up](images/agents-infra-setup1.svg "{{site.data.keyword.bpshort}} Agents set up"){: caption="{{site.data.keyword.bpshort}} Agents set up" caption-side="left"}
