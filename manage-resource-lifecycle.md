...
If you change the code of your Terraform template in GitHub, these changes are not available automatically when you create an execution plan in {{site.data.keyword.bplong_notm}}. To pull the latest changes from your GitHub repository, make sure that you click the **Pull latest** button from the workspace details page before you create your execution plan.
...
7. Click **View log** to review the log files of your execution plan. The log files provide a summary of all the resources that {{site.data.keyword.bplong_notm}} is about to remove. 
