...
5. Click **Generate plan** to create a Terraform execution plan. This action equals the `terraform plan` command. After you click the button, the workspace **Activity** page opens. 
...
5. Click **Generate plan** to create a Terraform execution plan. The workspace **Activity** page opens. 
...
7. Click **Apply plan** to apply the new Terraform template version. Depending on the changes that you made, it might take a few minutes or up to a few hours for the template to be applied.   
...
7. Click **Generate plan** to create a Terraform execution plan. The workspace **Activity** page opens. 
