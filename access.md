...
|-----|-----|-----|-----|--------|
| View workspace | ![Checkmark icon](images/checkmark.png) | ![Checkmark icon](images/checkmark-icon.svg) | ![Checkmark icon](images/checkmark-icon.svg) | ![Checkmark icon](images/checkmark-icon.svg) | 
