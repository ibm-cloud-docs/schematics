...
- Select the {{site.data.keyword.cloud_notm}} region you want to use to manage your {{site.data.keyword.bpshort}}. Set the region by running the command `ibmcloud target -r <us-south>`.
