...
- Select the {{site.data.keyword.cloud_notm}} region you wish to use to manage your {{site.data.keyword.bpshort}}. Set the region by running the command `ibmcloud target --region <us-south>`.
